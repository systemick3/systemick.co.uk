 ...
 */
class TweetsSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['twitter_username'] = array(
      ...
      '#maxlength' => 512,
      '#description' => t('The Twitter username for the user who\'s tweets we need to display.'),
      '#required' => TRUE,
    );
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $config->set('twitter_secret_key', $form_state->getValue('twitter_secret_key'))
      ...
      ->set('twitter_username', $form_state->getValue('twitter_username'))
